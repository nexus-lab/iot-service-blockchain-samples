...
- Make sure incoming traffic to port 7050, 8443, and 9443 of **all orderer nodes**
  (`orderer*.example.com`) and port 7051, 7052, and 9443 of **all peer nodes**
  (`peer*.org*.example.com`) are allowed by the network firewall.
