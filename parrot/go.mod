module github.com/nexus-lab/iot-service-blockchain-samples/parrot

go 1.17

require (
	github.com/Picovoice/porcupine/binding/go/v2 v2.1.1
	github.com/Picovoice/pvrecorder/sdk/go v1.0.2
	github.com/Picovoice/rhino/binding/go/v2 v2.1.1
	...
	github.com/nexus-lab/iot-service-blockchain v0.0.0-20220216051130-f41cbaed656d
